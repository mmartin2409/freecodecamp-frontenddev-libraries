const quotes = [
  ...
  {
    text: "Τίς εἶναι θέλεις, σαυτῷ πρῶτον εἰπέ: εἶθ' οὕτως ποίει ἃ ποιεῖς. ( .)",
    author: "Epictetus",
  },
  {
  ...
  {
    text: "Който не умее да владее себе си, той е роб, па ако ще да е владетел на целия свят. Епиктет",
    author: "Epictetus",
  },
  {
  ...
  {
    text: "Do not decorate the walls of your house with the valuable stones from Eubœa and Sparta; but adorn the minds (breasts) of the citizens and of those who administer the state with the instruction which comes from Hellas (Greece). For states are well governed by the wisdom (judgment) of men, but not by stone and wood.",
    author: "Epictetus",
  },
  {
  ...
  {
    text: "Älä pyri siihen, että kaikki tapahtuisi kuten haluat, vaan halua kaiken tapahtuvan niin kuin se tapahtuu. Silloin elämäsi on tasaista virtaa.",
    author: "Epictetus",
  },
  {
  ...
  {
    text: "REST.—If a man should be able to assent to this doctrine as he ought, that we are all sprung from God in an especial manner, and that God is the father both of men and of gods, I suppose that he would never have any ignoble or mean thoughts about himself. But if Cæsar (the emperor) should adopt you, no one could endure your arrogance; and if you know that you are the son of Zeus, will you not be elated?",
    author: "Epictetus",
  },
  {
  ...
  {
    text: "Rahatsız edici bir sorunun sakin bir şekilde üstesinden gelmek, benim içsel huzurum için ödediğim bedeldir. Kaygı ve endişeden özgür kalmam için ödediğim şeydir; işe yaramaz bir şey için değil.",
    author: "Epictetus",
  },
  {
  ...
  {
    text: "Hãy vứt ngay đi cái gì không phải của ta. Hãy thanh lọc các ý kiến của bạn để cái gì không thuộc về bạn sẽ không bám lấy bạn, đừng có dính vào đó và cũng đừng đau khổ khi người ta tước bỏ của bạn cái thứ không thuộc về bạn đó.",
    author: "Epictetus",
  },
  {
  ...
  {
    text: "Syyttää toisia omasta onnettomuudestansa on sivistymättömyyden merkki; syyttää itseänsä on sivistyksen alkeiden ilmaus, olla syyttämättä muita ja itseänsä on näyte ihmisen sivistyksestä.",
    author: "Epictetus",
  },
  {
    text: "Kun korppi koikkuu onnettomuutta ennustaen, älköön se näky sinua säikäyttäkö, vaan heti selitä ja sano itsellesi: tuo ei aavista mitään minulle, vaan ehkä raukalle ruumiilleni tai vähäpätöisille varoilleni tai mukamalle maineelleni tai lapsilleni tai vaimolleni. Minulle ennustaa kaikki onnea, jos minä tahdon, sillä mitä hyvänsä niistä tapahtuneekin, on minun vallassani käyttää sitä hyödykseni.",
    author: "Epictetus",
  },
  {
    text: "Don't just say you have read books. Show that through them you have learned to think better, to be a more discriminating and reflective person. Books are the training weights of the mind. They are very helpful, but it would be a bad mistake to suppose that one has made progress simply by having internalized their contents.",
  ...
  {
    text: "Pidä silmiesi edessä joka päivä kuolema ja maanpako ja kaikki kauheana näyttäytyvä, ennen kaikkea kuolema. Silloin et koskaan ajattele mitään matalamielistä etkä himoitse mitään likaa.",
    author: "Epictetus",
  },
  {
    text: 'Jos joku kertoo sinulle, että se ja se panettelee sinua, älä ryhdy puolustautumaan panetteluja vastaan, vaan sano: "Hän ei nähtävästi tiennyt muita vikojani, sillä muutoin hän ei olisi tyytynyt mainitsemaan vain noita.',
    author: "Epictetus",
  },
  {
  ...
  {
    text: "Il maggiore ostacolo al vivere è l’attesa, che dipende dal domani e consuma l’oggi.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "Δεν υπάρχει λοιπόν κανείς λόγος να πιστεύεις ότι κάποιος έχει ζήσει πολύ επειδή έχει άσπρα μαλλιά και ρυτίδες· δεν έζησε πολύ, απλώς και μόνο υπήρξε στη ζωή επί πολύ.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "Daher muß man sich durchringen zur Freiheit; diese aber erreicht man durch nichts anderes als durch Gleichgültigkeit gegen das Schicksal.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "Покажи мне, кто не раб. Один в рабстве у похоти, другой - у скупости, третий - у честолюбия и все - у страха.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "Pomozi onome koji nosi teret a ne onome  koji ga spušta pored tebe.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "No es que dispongamos de poco tiempo, es más bien que perdemos mucho.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "L’assalto delle avversità non smuove lo spirito dell’uomo forte: egli rimane impassibile e qualsiasi cosa accada l’assimila a sé, perché è più potente di tutte le cose esterne.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "الكورس : بأي خديعة قُضي عليهما ؟ الرسول : كما هي العادة في القضاء على الملوك . بالهدايا.",
    author: "Seneca",
  },
  {
  ...
  {
    text: 'Не прави добро, ако не си в състояние да приемеш неблагодарността" -',
    author: "Seneca",
  },
  {
  ...
  {
    text: "نار (الحب) عمياء إذ تغذيها (رياح) الغضب ،لاتريد الرضوخ ، لا تحتمل القيود ، لا تهاب الموت ، تهفو إلى مواجهة السيوف وجهاً لوجه.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "الطريق المألوف لا يكلف أحداً مشقة ، أسلك طريقاً كان آمناً لأشخاص سابقين ، لا تخرق - أيها الطائش - قوانين الكون المقدسة إلى أبعد الحدود.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "ако вървиш с очи,винаги обърнати към слънцето,ти никога няма да видиш сянка.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "No nos da miedo hacer las cosas porque sean difíciles, sino que las cosas son difíciles porque nos da miedo hacerlas.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "Pobre não é aquele que tem pouco, mas antes aquele que muito deseja.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "Nessun vento è favorevole per il marinaio che non sa a quale porto vuole approdare.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "Το θέμα όμως δεν είναι ότι έχουμε λίγο χρόνο ζωής, αλλ' ότι σπαταλάμε μεγάλο μέρος του.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "Τελικά όλοι συμφωνούν ότι σε καμία επιδίωξή του δε μπορεί να επιτύχει όποιος είναι απασχολημένος με πολλά πράγματα ταυτόχρονα, ούτε στο χώρο της ρητορικής ούτε σε εκείνων των ελευθέριων τεχνών, και τούτο επειδή ο νους που διασπάται δεν προσλαμβάνει τίποτα εις βάθος.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "Για να μάθει όμως κανείς πώς να ζει, θα πρέπει να αναλώσει ολόκληρη τη ζωή του και -γεγονός που θα σε εντυπωσίαζε περισσότερο- θα πρέπει εξίσου να αναλώσει ολόκληρη τη ζωή του για να μάθει πώς να πεθαίνει.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "Saiba que um teto de palha abriga o homem  tão bem quanto o de ouro.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "Nije da se ne usuđujemo zato što su stvari teške; već su stvari teške zato što se ne usuđujemo.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "Considérez bien toutes les choses dont la perte nous tire des larmes et nous trouble le sens ; vous trouverez que ce qui nous afflige n’est pas tant ce que nous perdons que ce que nous croyons avoir perdu. Personne ne sent la perte que dans son imagination (opinionem). Celui qui se possède ne peut rien perdre ; mais il y en a bien peu qui sachent se posséder",
    author: "Seneca",
  },
  {
    text: "La mauvaise habitude de se régler sur l’opinion d’autrui est si profondément enracinée, que le plus naturel de tous les sentiments, la douleur, a aussi son affectation",
    author: "Seneca",
  },
  {
  ...
  {
    text: "Non è perché ci appaiono inaccessibili che non abbiamo il coraggio di affrontare le cose: è perché non abbiamo il coraggio di affrontarle, che le cose ci appaiono inaccessibilil",
    author: "Seneca",
  },
  {
  ...
  {
    text: 'El verdadero héroe en una obra literaria es el lector que la aguanta".',
    author: "Seneca",
  },
  {
    text: "Disposons donc notre esprit à prendre en gré tout ce qui arrivera, et surtout que la pensée de notre fin ne nous afflige pas. Il faut faire ses préparatifs pour la mort avant que de songer aux provisions pour la vie",
    author: "Seneca",
  },
  {
  ...
  {
    text: "C’est la nature, dis-tu, qui me donne tous ces biens. Ne vois-tu pas qu’en parlant ainsi tu ne fais que changer le nom de Dieu ? La nature est-elle autre chose que Dieu et la raison divine, incorporée au monde entier et à chacune de ses parties ?",
    author: "Seneca",
  },
  {
    text: '[...] Preferirebbero vedere sottosopra lo Stato piuttosto che la loro capigliatura!Poco gli imposta se la testa è malata,basta faccia bella figura:meglio essere ben pettinati che dignitosi e onesti" [De brevitate vitae]',
    author: "Seneca",
  },
  {
  ...
  {
    text: "Afasta-te da companhia dos perniciosos, eles fazem nascer em ti um licenciosidade que lhe é natutal.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "Puisque le destin n’est que la succession des causes enchaînées l’une à l’autre, Dieu est la première de toutes les causes, d’où les autres découlent",
    author: "Seneca",
  },
  {
  ...
  {
    text: "أما أولئك الذين تمضي حياتهم ببطء وهم يتألمون فالحياة بالنسبة لهم هي الموت.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "كفى (الأعداء)أن بروا وجه هرقل الغاضب بدلاً من الموت وكفاهم أن يتلقوا تهديده.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "De su comunicación sacarás el fruto que quisieres, sin que por ellos quede el que consigas más cuanto más sacares. ¡Qué felicidad y qué honrada vejez espera al que se puso debajo de la protección de ésta! Tendrá con quien deliberar de las materias grandes y pequeñas, a quien consultar cada día en sus negocios, y de quien oír verdades sin injurias, y alabanzas sin adulación, y una idea cuya semejanza imite.",
    author: "Seneca",
  },
  {
    text: "LETTERA 28 È L'ANIMO CHE DEVI CAMBIARE, NON IL CIELO SOTTO CUI VIVI Prima esercita la funzione di accusatore, poi quella di giudice; e in ultimo quella di avvocato difensore. All'occorrenza, sappi anche infliggerti una condanna.",
    author: "Seneca",
  },
  {
    text: "LETTERA 27 LA VIRTÙ È FONTE DI FELICITÀ Resta ancora molto lavoro a cui tu, di persona, devi dedicare le tue veglie, le tue fatiche, se desideri che sia portato a compimento. A differenza di altri generi di lavoro, questo non ammette deleghe o aiuti.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "Was die Menschen anlangt, mit denen man es zu tun hat, so ist eine Auswahl ganz unerlässlich. Man frage sich: Sind sie es wert, dass wir einen Teil unserer Zeit an sie wenden?",
    author: "Seneca",
  },
  {
  ...
  {
    text: "LETTERA 20 I FATTI DEVONO ANDARE D'ACCORDO CON LE PAROLE Certo, il lettuccio e i panni rozzi non sono una prova sufficiente per dimostrare la buona disposizione d'animo, se non risulta chiaro che la povertà è stata scelta liberamente, non già tollerata per necessità.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "Za najmilszy rodzaj łaski uważał niewiedzę o tym, co każdy uczynił złego.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "LETTERA 25 DIVERSI MODI DI EDUCAZIONE Col peccatore inveterato penso che bisogni agire con un certo tatto, perché non giunga a disperare di sé stesso.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "Mas ésta es, querido Lucilio, mi súplica y exhortación: que introduzcas la filosofía en el fondo de tus entrañas, y que compruebes tu progreso no por lo que dices o escribes, sino por la firmeza del alma y por la disminución de los deseos. Demuestra las palabras con los hechos",
    author: "Seneca",
  },
  {
    text: "LETTERA 13 IL SAGGIO NON SI PREOCCUPA DEL FUTURO Osservali ad uno ad uno: troverai vecchi che ancora brigano per ottenere cariche politiche, o iniziano nuovi viaggi, o intraprendono nuovi affari. Che c'è di più brutto di un vecchio che vuole ricominciare a vivere?",
    author: "Seneca",
  },
  {
    text: "LETTERA 31 IL VERO BENE È STRETTAMENTE CONNESSO ALLA VIRTÙ Le voci che egli temeva erano carezzevoli ma isolate. Queste che dobbiamo temere noi non vengono da uno scoglio, ma risuonano tutt'intorno da ogni parte della terra. Perciò devi lasciarti dietro non solo un luogo sospetto per i suoi insidiosi piaceri, ma tutte le città.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "LETTERA 32 ACCELERA I TUOI PROGRESSI SPIRITUALI invero è molto dannoso anche chi fa indugiare, specialmente in una vita così breve, che noi abbreviamo ancor più con la nostra incostanza, ricominciando a viverla ora in un modo ora in un altro: la riduciamo a pezzetti e a brandelli.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "LETTERA 29 BISOGNA CONSIGLIARE A TEMPO UTILE Ho intenzione di avvicinarlo e di mostrargli come egli varrebbe di più se valesse di meno nella stima della folla.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "Oft hat ein hochbetagter Greis keinen anderen Beweis für die Länge seiner Lebens als die Summe seiner Jahre.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "Fa una scelta di buoni autori e contentati di essi per nutrirti del loro genio se vuoi ricavarne insegnamenti che ti rimangano. Voler essere dappertutto è come essere in nessu luogo. Non potendo quindi leggere tutti i libri che puoi avere, contentati di avere quelli che puoi leggere.",
    author: "Seneca",
  },
  ...
  {
    text: "LETTERA 38 VANTAGGI DELLA CONVERSAZIONE FAMILIARE I discorsi già preparati e pronunciati a gran voce davanti al pubblico degli ascoltatori hanno maggior risonanza, ma meno familiarità. La filosofia non è che un buon consiglio, ma nessuno dà un consiglio ad alta voce.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "Ein kleiner Teil des Lebens nur ist wahres Leben, der ganze übrige Teil ist nicht Leben, ist blosse Zeit",
    author: "Seneca",
  },
  {
  ...
  {
    text: "Занятой человек занят всем, кроме жизни. Нет ничего труднее, чем научиться жить",
    author: "Seneca",
  },
  {
  ...
  {
    text: "Gegen die Leidenschaften muss man in kräftigem Ansturm kämpfen, nich tmit bedächtiger Behutsamkeit",
    author: "Seneca",
  },
  {
  ...
  {
    text: "LETTERA 17 LA FILOSOFIA GIOVA IN OGNI CIRCOSTANZA DELLA VITA Così non importa se un animo malato sia posto fra le ricchezze o nella povertà: lo seguirà sempre il suo male.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "El mayor impedimento al vivir es la espera, que, por estar pendiente al día de mañana, pierde el día de hoy.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "Разбогатеть - не значит положить конец бедствиям но только променять их на другие",
    author: "Seneca",
  },
  {
  ...
  {
    text: "LETTERA 33 DEVI ACQUISTARE UN PENSIERO ORIGINALE, FRUTTO DELLA TUA ESPERIENZA Ricordare è custodire ciò che è stato affidato alla memoria, mentre sapere significa far proprie le nozioni apprese e non star sempre attaccato al modello, con lo sguardo sempre rivolto al maestro.",
    author: "Seneca",
  },
  { text: "reading of many books is distraction.", author: "Seneca" },
  {
    text: "LETTERA 26 TI GIUDICHERÀ LA MORTE Apparirà ciò che hai fatto nella vita solo quando esalerai l'ultimo respiro.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "LETTERA 21 LA VERA GLORIA In questi giardini gli stimoli della fame non si eccitano, ma si estinguono; né la sere aumenta col bere, ma è sedata da un rimedio naturale e gratuito.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "LETTERA 2 LA LETTURA CHE GIOVA È povero non chi possiede poco, ma chi brama avere di più.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "LETTERA 12 ANCHE LA VECCHIAIA HA LE SUE GIOIE Tutta la nostra esistenza è fatta di parti, è costituita, cioè, di cerchi più ampi che cingono cerchi sempre minori.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "LETTERA 22 OCCORRE ABBANDONARE LA VITA PUBBLICA AL MOMENTO GIUSTO Nessuno si preoccupa di una vita virtuosa, ma pensa solo a quanto tempo potrà vivere. Tuttavia tutti possono vivere bene, nessuno ha il potere di vivere a lungo.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "LETTERA 4 IL SAGGIO NON TEME LA MORTE Gli uomini, in maggioranza, ondeggiano tra il timore della morte e i tormenti della vita; non hanno il coraggio di vivere, né sanno morire.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "Solos aquellos gozan de quietud que se desocupan para admitir la sabiduría, y solos ellos son los que viven; porque no sólo aprovechan su tiempo, sino que le añaden todas las edades, haciendo propios suyos todos los años que han pasado;",
    author: "Seneca",
  },
  {
    text: "La vida es como una pieza teatral; no importa cuánto haya durado sino cuán bien haya sido representada",
    author: "Seneca",
  },
  {
  ...
  {
    text: 'El verdadero héroe en una obra literaria es el lector que la aguanta". Séneca.',
    author: "Seneca",
  },
  {
  ...
  {
    text: "LETTERA 19 LA VITA TRANQUILLA E I SUOI VANTAGGI Nel tuo modo di vivere non devi distinguerti troppo dagli altri, ma neppure devi rimanere nella completa oscurità.",
    author: "Seneca",
  },
  {
    text: "We ought not, therefore, to give over our hearts for good to any one part of the world. We should live with the conviction: 'I wasn't born for one particular corner: the whole world's my home country.",
  ...
  {
    text: "y así es forzoso que no sólo sea brevísima, sino miserable la vida de aquellos que con gran trabajo adquieren lo que con mayor han de poseer. Consiguen con su sudor lo que desean, y poseen con ansias lo que adquirieron con trabajo; y con esto no cuidan del tiempo, que pasando una vez, jamás ha de volver.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "LETTERA 37 IL DIFFICILE ESERCIZIO DELLA VIRTÙ La fortuna viene incontro a noi non meno spesso di quanto noi andiamo incontro a lei. È cosa vergognosa, anziché andare verso di lei, lasciarsi trascinare e, presi in mezzo al turbine degli eventi, chiederci con stupore. “Come mai son giunto qui?",
    author: "Seneca",
  },
  {
  ...
  {
    text: "LETTERA 30 COME AUFIDIO BASSO SI PREPARA ALLA MORTE Noi, più che la morte, temiamo il pensiero della morte. In ogni momento siamo ugualmente distanti dalla morte. Se essa deve essere temuta, dobbiamo temerla sempre, perché nessun periodo è esente dalla morte.",
    author: "Seneca",
  },
  {
    text: "Ser siempre dichoso y pasar la vida sin dentelladas en el espíritu es, de cierto, desconocer el otro lado de la naturaleza. Eres un gran hombre, pero ¿Cómo lo sé, si la suerte no te da ocasión de demostrar tu valor?",
    author: "Seneca",
  },
  {
    text: "Per essere felici bisogna eliminare due cose: il timore di un male futuro e il ricordo di un male passato; questo non ci riguarda più, quello non ci riguarda ancora.",
    author: "Seneca",
  },
  {
    text: "Que tú, dejados todos los asuntos, te apliques con tenacidad y te esfuerces en la sola tarea de hacerte cada día mejor, lo apruebo y me complazco de ello, y no sólo te animo a que perseveres, sino que además te lo ruego.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "La mayor rémora de la vida es la espera del mañana y la pérdida del día de hoy",
    author: "Seneca",
  },
  {
    text: "You should, I need hardly say, live in such a way that there is nothing which you could not as easily tell your enemy as keep to yourself;",
  ...
  {
    text: "Δούλευε σαν να πρόκειται να ζήσεις για πάντα, αγάπα σαν να πρόκειται να πεθάνεις σήμερα.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "Deve-se aprender a viver por toda a vida, e, por mais que tu talvez te espantes, a vida toda é um aprender a morrer.",
    author: "Seneca",
  },
  {
    text: "عاملوا من هم دونكم كما تحبون أن يعاملكم من هم فوقكم, وكلما ذكرتم ما لكم من سلطان على عبيدكم, اذكرو ايضاً أن لغيركم هذا السلطان نفسه عليكم",
    author: "Seneca",
  },
  {
  ...
  {
    text: "يجب أن تقدر الناس بأخلاقهم لا بما يؤدونه من اعمال, ذلك أن الاخلاق يكسبها الرجل نفسه, اما الاعمال التى يؤديها فإن الظروف هى التى تخلقها له",
    author: "Seneca",
  },
  {
    text: "LETTERA 5 INVITO ALLA SEMPLICITA' Nessuno è infelice solo per il presente.",
    author: "Seneca",
  },
  ...
  {
    text: "Não temos exatamente uma vida curta, mas desperdiçamos uma grande parte dela. A vida, se bem empregada, é suficientemente longa e nos foi dada com muita generosidade para a realização de importantes tarefas.",
    author: "Seneca",
  },
  {
    text: "LETTERA 34 INVITO ALLA VERA AMICIZIA È vero che, anche quando si è lontani, quelli che amiamo ci danno motivo di gioia, ma essa è lieve e fugace. Invece il loro aspetto, la loro presenza, la loro conversazione danno un senso di vivo piacere, specie se vediamo non solo la persona che desideriamo, ma come la desideriamo.",
    author: "Seneca",
  },
  {
    text: "Amintirea plăcerilor este mai de durată și mai de încredere decât prezența lor.",
    author: "Seneca",
  },
  {
    text: "São econômicos na preservação de seu patrimônio, mas desperdiçam o tempo, a única coisa que justificaria a avareza.",
    author: "Seneca",
  },
  {
    text: "Ninguém valoriza o tempo, faz-se uso dele muito largamente como se fosse gratuito.",
    author: "Seneca",
  },
  {
    text: "¿Preguntas cúal es el fundamento de la sabiduría? No gozarte en cosas vanas.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "No he nacido para un sólo rincón; mi patria es todo el mundo visible",
    author: "Seneca",
  },
  {
  ...
  {
    text: "El único bien, causa y soporte de la vida feliz, consiste en confiar en sí mismo.",
    author: "Seneca",
  },
  {
    text: "LETTERA 24 COME SI DEVE AFFRONTARE LA MORTE Come non vuota la clessidra l'ultima goccia, ma tutte quelle che sono già cadute, così, l'ultima ora in cui cessiamo di esistere, non produce, da sola, la morte, ma la compie; allora noi giungiamo al termine, ma da tempo vi siamo avviati.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "LETTERA 18 ELOGIO DELLA POVERTÀ Se non vuoi che uno si affanni e sia preso dal panico di fronte ad una triste realtà, fallo esercitare prima che essa si presenti.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "LETTERA 15: BISOGNA ESERCITARE LO SPIRITO, PIU' CHE IL CORPO Né il freddo, né il caldo, e neppure la vecchiaia, potrà impedire di esercitare le forze dell'animo: cura dunque questo bene, che diventa migliore col passare del tempo.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "Es seguro, es agradable el camino para el que la naturaleza te ha equipado. Ella te ha provisto de aquellos recursos que, si no los desaprovechas, te elevarán a la misma altura de Dios.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "Epicuro reprova igualmente os que cobiçam a morte e os que a temem, dizendo: “É ridículo correr para a morte entediado com a vida uma vez que foi com teu estilo de vida que provocaste essa corrida para a morte",
    author: "Seneca",
  },
  {
    text: "Sola la sabiduría es a quien no se puede hacer injuria; no la podrá borrar la edad presente, ni la disminuirá la futura, antes la que viniere añadirá alguna parte de veneración; porque la envidia siempre hace su morada en lo cercano, y con más sinceridad nos admiramos de lo más remoto.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "¿Qué mayor necedad que alabar en el hombre lo que no le pertenece?",
    author: "Seneca",
  },
  {
  ...
  {
    text: "LETTERA 23 LA VERA GIOIA Ma è difficile avere il senso della misura riguardo a ciò che si ritiene un bene.",
    author: "Seneca",
  },
  {
  ...
  {
    text: "«Come un racconto, così è la vita: non importa che sia lunga, ma che sia buona».",
    author: "Seneca",
  },
  {
  ...
  {
    text: "کمال شخصیت آن است که هر روز را به گونه ای سپری کنیم که انگار آخرین روز زندگانی ماست",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "إذا ما استطاعَ إنسانٌ أن يثبتَ لي أني على خطأ ويبين لي خطئي في أي فكرةٍ أو فعل ، فسوف أُغيِّر نفسي بكل سرور . أن أريدُ إلا الحق ، وهو مطلبٌ لم يضر أي إنسانٍ قط .  إنما الضررُ هو أن يُصرَّ المـرءُ على جهلهِ ويستمر في خداع ذاته .",
    author: "Marcus Aurelius",
  },
  ...
  {
    text: 'ثورو يقول : " أن تكون فيلسوفًا لا يعني أن يكون لديك أفكار حاذقة, ولا حتى أن تؤسِس مدرسة؛ بل أن تحب الحكمة بحيث تحيا وفقًا لإملاءاتها, حياة بساطة و إستقلال و سماحة و صدق. أن تكون فيلسوفًا هو أن تحلّ بعض مشكلات الحياة, لا حلًا نظريًا فقط, بل عمليًا أيضًا',
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: 'لا تُعلّق سعادتك على آرائ الآخرين فيك ولا تضع هناءك في أيديهم. ذلك " استرقاق " طوعي و " مصادرة " حياة و " نفي " خارج الذات. و ما كنت لترضي أيًّا من ذلك لو كنت تعرف إسمه الحقيقي.',
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "Precz z książkami! Już nie dawaj się im pociągnąć! Nie wolno! (...) Łaknienie zaś książek precz od siebie rzuć, byś nie umierał wśród narzekań, lecz spokojnie.",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "الأذى لا يأتيك إلّا من ذاتك. الأشياء بريئة و خاملة و مُحايدة. ليست الأشياء ما يُربكك بل فكرتك عنها.",
    author: "Marcus Aurelius",
  },
  {
    text: "لا مجد لك بمعزل عن مجد قومك. ما لا يفيد السّرب لا يفيد النحلة. لا مجد لنحلةٍ في خليةٍ منهارة.",
    author: "Marcus Aurelius",
  },
  {
    text: "IN THE morning when thou risest unwillingly, let this thought be present- I am rising to the work of a human being. Why then am I dissatisfied if I am going to do the things for which I exist and for which I was brought into the world?",
  ...
  {
    text: "No te aficiones más que a lo que te acontezca y a lo que forme la trama de la vida. ¿Pues qué otra cosa podrá serte más oportuna?",
    author: "Marcus Aurelius",
  },
  {
    text: "ألم يأن لك أن تفهم أن هذا العالم الذي أنت جزءٌ منه و تفهم مدبّر هذا العالم الذي أنت فيضٌ منه؟ ألا تدرك ان هناك حدًا لعمرك, فإذا لم تستغله لتبديد غيومك فسوف يذهب العمر و سوف تذهب و لن تعود الفرصة مرة أخرى؟",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "تمادي في إيذاء ذاتك أيتها النفس .. إن هي إلا لحظة ولن يعود لديك مُتسع لاعتبار ذاتك . الحياةُ لحظة ، ولحظتك الخاصة تُوشكُ علـى النهاية والسعادة تتعلق على تقدير الذات لذاتها ، ومازلت تحرمينها من ذلك وتعلقين سعادتك على الآخرين",
    author: "Marcus Aurelius",
  },
  ...
  {
    text: "Y recuerda que has de tratarles como a hombres, porque son tan humanos como tú y por tanto te resultan tan imprescindibles como la mandíbula inferior lo es para la superior.",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "Τοῦτο ἔχει ἡ τελειότης τοῦ ἤθους, τὸ πᾶσαν ἡμέραν ὡς τελευταίαν διεξάγειν καὶ μήτε σφύζειν μήτε ναρκᾶν μήτε ὑποκρίνεσθαι.",
    author: "Marcus Aurelius",
  },
  {
    text: "Souviens toi que chacun ne vit que dans le moment présent, dans l'instant. Le reste, c'est le passé ou un obscur avenir. Petite est donc l'étendue de la vie.",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "El movimiento de los átomos corre hacia arriba, hacia abajo, circularmente. Pero el curso de la virtud no está sujeto a ninguno de estos giros. Tiene, más bien, un no sé qué divino, de modo que hace su jornada por una órbita difícil e incomprensible.",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "ما كان يوماُ جَهلُ المرء بما يدور في رءوس الآخرين سبباً للتعاسة والشقاء . أنما الشقي من لا ينتبه إلى خطراتِ عقلهِ هو ، ولا يـهتدي بهديـه وإرشاده",
    author: "Marcus Aurelius",
  },
  {
    text: "إن خطيئة الرغبة أجدرُ باللوم من خطيئة الغضب . إذ أن الأولُ أشبه بشخصٍ أُذِيَ فاضرَّه الألمُ إلى الغضب ، أما الثاني فإنه هو مصدر نزوته ومنشأ اندفاعته إلى الأثم حين تحدوه الشهوة إلى ارتكاب ما ارتكب",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "لامجد لك بمعزل عن مجد قومك . مالا يفيد السرب لايفيد النحلة . لامجد لنحلة في خلية منهارة",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "لكل شيء في الطبيعة دوره في حبكة الكل , حتى النائم وحتى المخرب ..حتى مخلفات الطبيعة وعوارضها الضارة هي نواتج بعدية للنبيل والجميل",
    author: "Marcus Aurelius",
  },
  {
    text: "Reject your sense of injury, and the injury itself disappears.",
  ...
  {
    text: 'قيل لزينون "أي الملوك أفضل: ملك اليونانيين أم الفرس؟" قال: "من ملك شهوته وغضبه',
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "الكتابة ارتقاء من الخصوصية إلى العمومية، تحقيق لما هو كامن في العقل، وتحديد لما هو غائم، وتثبيت لما هو هائم. بل هي بحث عن المجهول منن خبايا النفس، ومعرفة بما هو ضائع في تضاعيف الذات.  لست أعرف بالضبط ما أنا أفكر فيه؛ ربما لذلك شرعت في كتابته",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "الزهو بالخلو من الزهو هو أثقل ضروب الزهو وأصعبها على الاحتمال أثقل الغرور التواضع الزائف",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "No malgastes lo que te queda de vida en conjeturar sobre los demás, a no ser que busques el bien común; pues si te dedicas a imaginar qué hace la gente, por qué, qué dice, que piensa, qué trama, y cosas parecidas, dejarás de observar tu propia conciencia interior.",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "It isn't ceasing to live that [I'm] afraid of but never beginning to live properlyز",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "Es ridículo no intentar evitar tu propia maldad, lo cual es posible, y, en cambio, intentar evitar la de los demás, lo cual es lo imposible.",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "Her şey düşüncenin verdiği biçimi alır. Ve düşüncenizin kontrolü sizin elinizdedir. Dolayısıyla yargılarınızı ortadan kaldırmaya karar verdiğinizde huzura kavuşursunuz. Tıpkı, burnu dolaşan bir denizcinin sakin suya, dalgasız bir koya erişmesi gibi.",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "ناور العقبات ، واتخذ منها وقوداً لفضيلتك ، واسع إلى مقاصدك بتحفظ يخفف عنك صدمة الاخفاق",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "Desnudas de su corteza contempla las causas: los significados de las acciones, qué es el sufrimiento, qué es el placer, qué es la muerte, qué es la fama, quién es el culpable de tu propia falta de tiempo, cómo nadie es impedido por otro, que todo es suposición[482].",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "No hay que censurar a los dioses porque no yerran en nada, ni contra su voluntad ni a propósito. Tampoco a los hombres, porque en nada yerran si no es contra su voluntad. En conclusión no hay que censurar a nadie.",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "Está cerca que tú te olvides de todo y también lo está que todos te olviden.",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "Si te afliges por alguna causa externa, no es ella lo que te importuna, sino el juicio que tú haces de ella. Y borrar ese juicio, de ti depende. Pero si te aflige algo que radica en tu disposición, ¿Quién te impide rectificar tu criterio?",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "Wie weit bist du in der Erkenntnis, daß keine andere Lebensweise zum Philosophieren so geeignet sei, als die, die du jetzt gerade führst?",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "si te elevaran en el aire y miraras hacia abajo las cosas humanas y su versatilidad, piensa que las despreciarías al verlas todas al mismo tiempo que las que habitan por todo el aire y la atmósfera[489]. Y que cuantas veces seas elevado verás lo mismo, lo semejante, su brevedad. De eso depende el delirio de grandeza.",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "el no dejarme regir, ni aun en las cosas mínimas, por otros principios que por la razón;",
    author: "Marcus Aurelius",
  },
  {
    text: "Mihin tahansa kyllästyisinkin, niin aina pysyn onnellisena, sillä onnellinen on se, joka pystyy luomaan itselleen onnellisen kohtalon. Onnellinen kohtalo taas on hyvä mieliala, hyvät taipumukset, hyvät teot.",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "Im allgemeinen schadet das Böse der Welt nicht, und im einzelnen Falle schadet es nur dem, dem es vergönnt ist, sich frei davon zu machen, sobald er nur will.",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "Basta abandonar todo o passado, confiar o futura à providência e dirigir a ação presente para a piedade e a justiça.",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "Por lo demás, todo lo que es bello en cierto modo, bello es por sí mismo, y termina en sí mísmo sin considerar el elogio como parte de sí mismo. En consecuencia, ni se empeora ni se mejora el objeto que se alaba.",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "Предметы, преследуя и избегая которые, ты лишаешься мира душевного, не приступают к тебе, но ты некоторым образом сам приступаешь к ним. Пусть смолкнет твое суждение о них – и они лежат недвижимо; а тебя никто не увидит ни преследующим, ни бегущим.",
    author: "Marcus Aurelius",
  },
  {
    text: "No obres como quien ha de vivir diez mil años. Lo irreparable está ya suspendido encima de ti. Mientras vives, mientras es aún posible, sé hombre de bien.",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "preocuparse de su propio cuerpo con mesura, no como si tuviera apego a la vida, sin llegar al maquillaje pero tampoco desde luego al abandono, de forma que por su propia diligencia precisaba poquísimo de la medicina, de sus medicamentos o ungüentos, de uso interno o externo; ceder",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "¡Cuánta holgura se logra si no se mira lo que el vecino dijo, hizo o pensó, sino lo que hace uno mismo, para que también esta acción sea justa, santa y conforme con el bien! No observes los malos caracteres, sino lleva adelante tu camino hacia el fin, sin mirar acá ni allá, por los lados.",
    author: "Marcus Aurelius",
  },
  {
    text: "aplicar la anécdota referida a Sócrates[162] de que podía al tiempo abstenerse y disfrutar de aquello por lo que la mayoría en caso de abstinencia se siente débil y en caso de disfrute se dejan llevar; ser fuerte y resistente y en ambas cosas ser sobrio [es",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "Desde el alba hay que decirse con énfasis a uno mismo: me toparé con el entrometido, con el desagradecido, con el soberbio, con el taimado, con el malicioso, el insociable. Todos",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "Estás viendo qué pocas son las cosas que debe uno dominar para poder vivir una vida próspera y respetuosa con la divinidad, porque los dioses no exigirán nada más al que mantenga esto.",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "que está enojado se revuelve contra la razón aparentemente con cierta tristeza y encogimiento inconsciente, mientras que el que yerra por apetencia se deja vencer por el placer y aparentemente es más licencioso y femeninamente débil en sus faltas. Con",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "2.12 Es propio de la facultad inteligente fijarse en cómo desaparece rápidamente todo, las propias personas en el universo, los recuerdos de esas personas en el tiempo; en",
    author: "Marcus Aurelius",
  },
  ...
  {
    text: "No hay nada más desventurado que quien recorre todo en derredor, explora »lo que está debajo de la tierra«, dice[193], e investiga en las almas de los que están cerca mediante el uso de indicios[194], sin darse cuenta de que basta estar sólo ante el espíritu divino que está dentro de uno mismo y ser su servidor de verdad. Este",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "Qui una sola cosa ha valore: trascorrere tutta la vita nella verità e nella giustizia pur trattando con indulgenza i bugiardi e gli ingiusti.",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "Стига само да се съсредоточиш в живота, който живееш, тоест в настоящето, ти ще можеш да изживееш оставащото до смъртта време без смут, в добро разположение на духа и настроен доброжелателно към своето божество.",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "Basta con poner tu atención y deseo en ser bueno contigo mismo en cualquier cosa que hagas. Recuerda",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "Excava dentro. Dentro está la fuente del bien que puede siempre borbotar de nuevo mientras excaves.",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "El arte de vivir es más parecido al de la lucha que al de la danza en la medida que, ante lo que le cae a uno de improviso, hay que mantenerse preparado y sin caerse.",
    author: "Marcus Aurelius",
  },
  ...
  {
    text: "No reniegues, ni renuncies, ni te impacientes, si no se materializa la ejecución de cada acción según criterios rectos; por el contrario, aunque te quedes fuera de combate, vuelve a él con insistencia, conténtate si la mayor parte de tus acciones están por encima de lo humano y desea el combate al que vuelves. No",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "Acuérdate de esto y de lo siguiente, que de poquísimas cosas depende tener una vida feliz. Y",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "Hipócrates[207], tras sanar muchas enfermedades, enfermó él y murió. Los",
    author: "Marcus Aurelius",
  },
  {
    text: "La perfección del carácter supone que cada día transcurra como el último, sin palpitos, sin cabezadas, sin actuaciones teatrales.",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "Há fulanos que quando fazem algum favor a alguém estão logo prontos para lançar no livro de contas o agradecimento devido.",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "Ἕωϑεν προλἐγειν ἑαυτῷ συντεύξομαι περιὲργω, ἀχαρίστῳ, ὑβριστῆ, δολερῷ, βασϰάνω, ἀϰοινωνήτω.",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "Ведь тот, кто отдал предпочтение своему духу, гению, служению добродетели, не надевает трагической маски, не издает стенаний, не нуждается ни в уединении, ни в многолюдстве. Он будет жить – и это самое главное – ничего не преследуя и ничего не избегая.",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "no ser tramposo, tener nobleza, aguantar los trabajos, despreciar los placeres, no quejarse de tu destino, necesitar poco, la buena disposición, la liberalidad, la sencillez, no ser charlatán, la grandeza. ¿",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "¡Cuántos de los agasajados con muchos himnos están ya entregados al olvido! ¡Cuántos de los que hicieron esos himnos hace tiempo que están ausentes!",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "No te avergüences de recibir ayuda porque tienes delante realizar la tarea que te corresponde como el soldado que ataca una muralla. ¿",
    author: "Marcus Aurelius",
  },
  {
    text: "What then is that which is able to conduct a man? One thing and only one, philosophy. But this consists in keeping the daemon within a man free from violence and unharmed, superior to pains and pleasures, doing nothing without purpose, nor yet falsely and with hypocrisy, not feeling the need of another man’s doing or not doing anything; and besides, accepting all that happens, and all that is allotted, as coming from thence, wherever it is, from whence he himself came; and, finally, waiting for death with a cheerful mind, as being nothing else than a dissolution of the elements of which every living being is compounded.",
  ...
  {
    text: "Тебя увлекает мечта о славе? Обрати внимание на то, как быстро все предается забвению, на хаос времени, беспредельного в ту и другую сторону, на суетность похвал, изменчивость и безрассудство тех, которые, по-видимому, тебя ценят, на незначительность пространства, пределами коего слава ограничена.",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "Hay que reflexionar continuamente en cuántos médicos han muerto tras haber fruncido el entrecejo muchas veces por sus enfermos",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "hay que ver siempre lo humano como flor de un día e inconsistente, ayer era una mucosidad, mañana será momia y cenizas. Ese",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "habla y actúa en todo según lo que sea más sano. Ese planteamiento te libera de golpes, de vacilación, de preocupación y afectación.",
    author: "Marcus Aurelius",
  },
  {
    text: "No malogres la parte de vida que te queda en averiguar vidas ajenas, a no ser que te propongas algún fin útil a la comunidad.",
    author: "Marcus Aurelius",
  },
  {
    text: "la naturaleza también nos dio su medida, también nos la dio del comer y del beber, no obstante, tú sobrepasas lo que es suficiente. Pero",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "Устрани убеждение, устранится и жалоба на вред. Устрани жалобу на вред, устранится и самый вред.",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "Que no te aparte que detrás venga la crítica o la palabra de algunos, por el contrario, si está bien hecho o bien dicho, no te subestimes. Ellos",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "Если ты огорчаешься по поводу чего-либо внешнего, то угнетает тебя не сама эта вещь, а твое суждение о ней. Но устранить последнее в твоей власти.",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "¡A cuántos Crisipos se ha tragado ya la eternidad, a cuántos Sócrates, a cuántos Epictetos! Que se te ocurra lo mismo ante absolutamente cualquier hombre y cosa.",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "Si la ciudad se perjudica no hay que irritarse con quien la perjudica, por el contrario hay que señalarle qué es lo que le pasó desapercibido.",
    author: "Marcus Aurelius",
  },
  {
  ...
  {
    text: "tanto el que goza de un tiempo más largo como el que ha de morir rápidamente deja atrás lo mismo, porque sólo es el presente de lo que va a verse privado, si es eso lo único que tiene y si uno no deja atrás lo que no tiene.",
    author: "Marcus Aurelius",
  },
  {
